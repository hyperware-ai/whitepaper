...
The specification of KNS itself, as a protocol within this namespace, is described in Section~\ref{sec:kns}, as is the specification of the Kinode Package Manager, Section~\ref{sec:ospackagemanager}, which makes an appearance in this example.
