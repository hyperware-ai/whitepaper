...
\keywords{Operating System \and Decentralized \and Cloud \and Wasm \and Cryptocurrency \and Public-Key Infrastructure \and Namespace \and Peer-to-Peer \and Smart Contract Account }
\end{abstract}
%
%
%
...
% I do not know if I'd describe the minimal verification as the most important details
...
% \subsection{KiMap Entries and Key Types}
...
\item A Kinode specific definition fallback modules and installation practices.
\item An ability for names in the KiMap to specify required modules to install into their subsection of the namespace.
\end{itemize}
...
\subsection{Kinode Fallback Modules}

\subsection{Hierarchical Module Installation}
