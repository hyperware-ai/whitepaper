...
Discoverability can present both social barriers (finding a new user on a game or chat) and technical obstacles (automatically aquiring networking information for a particular username).
...
[TODO provide spec for scripts.json]
...
Now, we must discuss two risks facing kimap+KINO.
...
Tight integration in the OS itself will also mitigate this risk.
