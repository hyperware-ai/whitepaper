...
Developers can make use of existing Unix tools, e.g., SSH tunnels, to use kit on remote Kinodes.
As such, developers can work on remote Kinodes with the same ease that \verb|kit| affords for local development, but security is not compromised for users.
