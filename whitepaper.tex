...
This token is acquired via use of the protocol itself: by registration of \$KINO.

Registering \$KINO mints an equivalent amount of \$veKINO to the address which performs the registration.
...
The lock duration produces a decay curve which determines the voting power of \$veKINO created from registration.
